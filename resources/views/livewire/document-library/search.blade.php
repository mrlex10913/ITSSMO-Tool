<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-2 text-sm text-gray-600">Find documents in the Document Library</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                        ...
                        <div class="space-y-2 text-xs text-gray-500">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-1">
                                    ...
                                    <span class="inline-flex items-center px-1.5 py-0.5 rounded text-xs font-medium bg-yellow-100 text-yellow-800" title="A newer version is available">
                                        <span class="material-symbols-sharp text-xs mr-0.5">update</span>
                                        Outdated
                                    </span>
                                    @endif
                                </div>
        ...
        <div class="p-12 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                @endif
                <a href="{{ route('document-library.upload') }}"
